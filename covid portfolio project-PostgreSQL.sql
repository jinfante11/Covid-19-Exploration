...
SELECT location, population,date AS YearMonth , COALESCE(MAX(total_cases),0) AS HighestInfectionCount,  COALESCE(Max((total_cases/population))*100,0) as PercentPopulationInfected
FROM CovidDeaths
WHERE continent IS NOT NULL 
